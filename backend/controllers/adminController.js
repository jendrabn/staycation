...
module.exports = {
  ...
  actionSignIn: async (req, res) => {
    try {
      ...
      if (!user) {
        req.flash("alertMessage", "Username is not registered!");
        req.flash("alertStatus", "danger");
        res.redirect("/admin/signin");
      }
      ...
      if (!isPasswordMatch) {
        req.flash("alertMessage", "Wrong username or password!");
        req.flash("alertStatus", "danger");
        res.redirect("/admin/signin");
      }
  ...
  viewDashboard: async (req, res) => {
    try {
      const total = {
        member: await Member.countDocuments(),
        order: await Booking.countDocuments(),
        item: await Item.countDocuments(),
      };
  ...
  editBank: async (req, res) => {
    try {
      ...
      if (req.file != undefined) {
        const imagePath = path.join(`public/${bank.imageUrl}`);
  ...
  deleteItem: async (req, res) => {
    try {
      ...
      await item.remove();
      req.flash("alertMessage", "Item removed");
      req.flash("alertStatus", "success");
      res.redirect("/admin/item");
    } catch (error) {
      req.flash("alertMessage", error.message);
  ...
  deleteFeature: async (req, res) => {
    ...
    try {
      ...
      req.flash("alertMessage", "Feature removed");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", error.message);
  ...
  deleteActivity: async (req, res) => {
    ...
    try {
      ...
      req.flash("alertMessage", "Activity removed");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", error.message);
